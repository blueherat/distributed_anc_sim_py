...
def main() -> int:
    ...
    stage_cfg = resolve_stage_level("03", args.level, num_samples=args.num_samples)
    output_h5 = args.output_h5 or str(Path(__file__).resolve().parents[1] / "data" / f"single_control_anechoic_{stage_cfg['level'].lower()}.h5")
