...
def main() -> int:
    ...
    parser.add_argument("--candidate-mode", type=str, default="auto")
    parser.add_argument("--geometry-filter-mode", type=str, default="none", choices=["none", "stable"])
    parser.add_argument("--live-plot", action="store_true")
    args = parser.parse_args()
    stage_cfg = resolve_stage_level("01", args.level, epochs=args.epochs)
    ...
    summary = train_localization_suite(
        h5_path,
        output_dir,
